...
/*        userEntity.setDateOfBirth(Utills.getCurrentDate());
    ...
    @Test
    @DisplayName("JUnit test for saveUserDetails method Throw Exception")
    public  void  givenUserObject_whenSaveUserObject_ThenThrowException(){
        given(iUserRepository.findByEmail(prepaireUserDto().getEmail()))
                .willReturn(Optional.empty());
    ...
    public  void  givenUserId_whenGetUserDetailsById_ThenThrowException(){
        given(iUserRepository.findById(1)).willReturn(Optional.of(userEntity));
    ...
    @Test
    public void givenUserId_whenDeleteUser_thenReturnUserIdIsNotPresent(){
        // given - precondition or setup
        Integer userId = 1;
    ...
    @Test
    public void givenUserId_whenDeleteUser_thenThrowException(){
        // given - precondition or setup
        Integer userId = 1;
    ...
    @Test
    public  void giveEmailId_whenGetUserByEmail_thenThrowException(){
    ...
    public  void  givenUserId_whenUpdateUser_ThenReturnMsgUserNotPresent(){
        given(iUserRepository.findById(1)).willReturn(Optional.empty());
        Map<String,String> error=new HashMap();
        error.put(UserServiceConstant.error_code,UserServiceConstant.BAD_REQUEST);
        error.put(UserServiceConstant.error_message,UserServiceConstant.USER_IS_NOT_PRESENT_FOR_GIVEN_ID);
    ...
    public  void  whenGetUsers_ThenReturnListUser(){
    ...
    public  void  whenGetUsers_ThenThrowException(){
        Pageable paging = PageRequest.of(0, 2, Sort.by("inventory"));
        Page<UserEntity> userEntityPage= Mockito.mock(Page.class);
        given(iUserRepository.findAll(paging)).willReturn(userEntityPage);
